...
class Database:
    def __init__(self, filename: str = None):
        custom_name = f"_{filename}" if filename else ""
        self.conn = sqlite3.connect(
            f"./database/storage{custom_name}.db", isolation_level=None, detect_types=sqlite3.PARSE_DECLTYPES
        )
...
class Table(metaclass=TableMeta):
    ...
    @classmethod
    def create(cls, *, filename: str = None, verbose: bool = False):
